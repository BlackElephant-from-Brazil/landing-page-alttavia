...
/**
 * The dashboard of an account with no order yet: one line and the way to
 * the wizard. Reached by someone who signed in before finishing /en/apply,
 * or who came back with a fresh account.
 */
